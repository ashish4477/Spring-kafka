...
public class HelloKafkaController {
    ...
    @KafkaListener(topics = "sampleTopic", clientIdPrefix = "json",
    ...
    @KafkaListener(topics = "sampleTopic", clientIdPrefix = "string",
    ...
    @KafkaListener(topics = "sampleTopic", clientIdPrefix = "bytearray",
